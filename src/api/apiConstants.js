...
export const projectionExpressionMenuDay = 'id,title,dateFrom,dateTo,description,menuItemIdsJSON,associatesJSON';
export const projectionExpressionAssociate = 'id,firstName,lastName,bio,jobTitle,email,restaurantIdsJSON,imageUrl';
export const projectionExpressionEntertainmentItem = 'id,title,timeFrom,timeTo,description,imageUrl';
