...
const SignedInTopToolBar = () => {
    ...
    const myRestaurantMenuItems: any = associatesRestaurants.map((restaurant: { id: React.Key | readonly string[] | null | undefined; restaurantName: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; }) => <MenuItem
    // value={restaurant.id}
    // key={restaurant.id}
    >
